...
class Dataset_Dance(torchData):
    def __init__(self, root, transform, mode='test', video_len=7, partial=1.0):
        ...
        for idx in range(data_num):
            self.img_folder[idx] = [path.replace('\\', '/') for path in self.img_folder[idx]]
...
def main(args):
    ...
    print(f"參數數量：{pytorch_total_params}")
...
if __name__ == '__main__':
    ...
    main(args)
#python Lab4_template/Tester.py --DR LAB4_Dataset/LAB4_Dataset --save_root ./ --ckpt_path ./"test_epoch=0.ckpt"